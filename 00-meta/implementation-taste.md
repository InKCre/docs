...
1. Load this guidance through the root `AGENTS.md` entry point.
...
5. If a verified lesson is stable and expensive to rediscover, promote it to the proper durable owner: Product TDD, Unit TDD, local `AGENTS.md`, Deployment, or Meta Engine.
