...
For non-trivial code work, use `implementation-taste.md` to check whether the failure came from authority drift, trust-boundary confusion, semantic naming drift, or unjustified complexity.
