...
- product boundary: an InKCre deployment is one owner context. Runtime participants are Peer nodes, while users or accounts named by an external protocol remain protocol-bound projections rather than InKCre tenants.
