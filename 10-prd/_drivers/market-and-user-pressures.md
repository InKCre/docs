...
- market pressure: information saved across external systems loses value when people cannot find or use it again when needed.
...
- urgency and tradeoff: the product optimizes for putting collected information to use rather than treating capture, storage, or source-specific extraction as the outcome.
